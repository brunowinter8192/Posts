...
Was den Code angeht, entscheidet der Agent die Einteilung in Ordner, es gibt keine Fragen wie etwa bei der Doku bei den Areas. Die einzigen Rules sind, dass ein Modul nur dann auf Root-Ebene liegen darf, wenn mindestens zwei Ordner es brauchen oder ein externer Einstiegspunkt es direkt lädt, und dass die Code-Docs immer auf der Stufe der Module liegen, auf die sie sich beziehen.
